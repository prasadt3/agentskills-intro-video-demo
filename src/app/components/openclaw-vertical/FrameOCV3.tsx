...
// Frame 3: Solution intro - "What if..." (vertical)
export function FrameOCV3() {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <motion.p
          className="text-[24px] tracking-[-0.02em] leading-tight mt-1"
      ...
      >
        ...
        <p
          className="text-[48px] tracking-[-0.03em]"
